export const seedUsers = [
  { id: 'u1', name: 'Sarah Connor', email: 'sarah.c@skynet.com', joined: '2023-10-12', lastActive: '2024-06-15T10:30:00', status: 'Active', role: 'Listener', verified: true, topListener: true, staff: false },
  { id: 'u2', name: 'James Miller', email: 'j.miller@mediahub.org', joined: '2023-09-28', lastActive: '2024-06-14T08:00:00', status: 'Disabled', role: 'Editor', verified: true, topListener: false, staff: true },
  { id: 'u3', name: 'Elena Kovic', email: 'elena.kovic@sonic.io', joined: '2024-01-05', lastActive: '2024-06-15T10:15:00', status: 'Active', role: 'Admin', verified: true, topListener: false, staff: true },
  { id: 'u4', name: 'Brandon Tye', email: 'b.tye@freelance.fm', joined: '2023-12-18', lastActive: '2024-06-15T06:00:00', status: 'Pending', role: 'Listener', verified: false, topListener: false, staff: false },
  { id: 'u5', name: 'Maya Lopez', email: 'maya.lopez@onair.com', joined: '2024-02-22', lastActive: '2024-06-15T10:32:00', status: 'Active', role: 'Staff', verified: true, topListener: true, staff: true },
  { id: 'u6', name: 'DJ Z-Blast', email: 'zblast@hot1015.com', joined: '2023-03-10', lastActive: '2024-06-15T09:45:00', status: 'Active', role: 'Staff', verified: true, topListener: false, staff: true },
  { id: 'u7', name: 'Marcus Chen', email: 'marcus.chen@gmail.com', joined: '2024-06-15', lastActive: '2024-06-15T10:27:00', status: 'Active', role: 'Listener', verified: false, topListener: false, staff: false },
  { id: 'u8', name: 'Priya Sharma', email: 'priya.s@outlook.com', joined: '2023-07-04', lastActive: '2024-06-13T14:22:00', status: 'Active', role: 'Listener', verified: true, topListener: true, staff: false },
  { id: 'u9', name: 'Tom Nguyen', email: 'tom.ng@sonic.io', joined: '2023-11-15', lastActive: '2024-06-10T11:00:00', status: 'Disabled', role: 'Editor', verified: true, topListener: false, staff: true },
  { id: 'u10', name: 'Ashley Brooks', email: 'ashley.b@hot1015.com', joined: '2024-03-01', lastActive: '2024-06-15T08:30:00', status: 'Active', role: 'Admin', verified: true, topListener: false, staff: true },
  { id: 'u11', name: 'Carlos Rivera', email: 'carlos.r@fm.com', joined: '2023-08-20', lastActive: '2024-06-14T16:45:00', status: 'Active', role: 'Listener', verified: true, topListener: true, staff: false },
  { id: 'u12', name: 'Zoe Kim', email: 'zoe.kim@beats.co', joined: '2024-01-30', lastActive: '2024-06-12T09:10:00', status: 'Active', role: 'Listener', verified: false, topListener: false, staff: false },
  { id: 'u13', name: 'Liam O\'Brien', email: 'liam.ob@radio.net', joined: '2023-06-12', lastActive: '2024-06-15T07:55:00', status: 'Active', role: 'Listener', verified: true, topListener: false, staff: false },
  { id: 'u14', name: 'Fatima Al-Hassan', email: 'fatima.h@music.org', joined: '2024-04-08', lastActive: '2024-06-11T13:20:00', status: 'Pending', role: 'Listener', verified: false, topListener: false, staff: false },
  { id: 'u15', name: 'Derek Washington', email: 'derek.w@station.fm', joined: '2023-05-22', lastActive: '2024-06-14T19:00:00', status: 'Active', role: 'Staff', verified: true, topListener: false, staff: true },
  { id: 'u16', name: 'Nina Petrova', email: 'nina.p@audio.com', joined: '2023-09-03', lastActive: '2024-06-08T10:00:00', status: 'Disabled', role: 'Listener', verified: true, topListener: false, staff: false },
  { id: 'u17', name: 'Jake Sullivan', email: 'jake.s@livefm.co', joined: '2024-02-14', lastActive: '2024-06-15T10:05:00', status: 'Active', role: 'Listener', verified: false, topListener: false, staff: false },
  { id: 'u18', name: 'Amara Osei', email: 'amara.o@groove.fm', joined: '2023-12-01', lastActive: '2024-06-14T22:30:00', status: 'Active', role: 'Listener', verified: true, topListener: true, staff: false },
  { id: 'u19', name: 'Ryan Park', email: 'ryan.p@hot1015.com', joined: '2023-04-18', lastActive: '2024-06-15T09:00:00', status: 'Active', role: 'Editor', verified: true, topListener: false, staff: true },
  { id: 'u20', name: 'Sophie Turner', email: 'sophie.t@media.co', joined: '2024-05-10', lastActive: '2024-06-15T10:20:00', status: 'Active', role: 'Listener', verified: false, topListener: false, staff: false },
  { id: 'u21', name: 'Marco Diaz', email: 'marco.d@beats.fm', joined: '2023-10-30', lastActive: '2024-06-13T15:45:00', status: 'Active', role: 'Listener', verified: true, topListener: false, staff: false },
  { id: 'u22', name: 'Hana Yuki', email: 'hana.y@sonic.io', joined: '2024-01-18', lastActive: '2024-06-09T12:00:00', status: 'Pending', role: 'Listener', verified: false, topListener: false, staff: false },
  { id: 'u23', name: 'David Jones', email: 'david.j@hot1015.com', joined: '2022-08-01', lastActive: '2024-06-15T10:30:00', status: 'Active', role: 'Editor', verified: true, topListener: false, staff: true },
  { id: 'u24', name: 'Sarah Miller', email: 'sarah.m@sonic.io', joined: '2023-02-15', lastActive: '2024-06-15T09:30:00', status: 'Active', role: 'Editor', verified: true, topListener: false, staff: true },
  { id: 'u25', name: 'Alex Rivera', email: 'alex.r@hot1015.com', joined: '2022-01-10', lastActive: '2024-06-15T10:32:00', status: 'Active', role: 'Admin', verified: true, topListener: false, staff: true },
]
...
export const seedArticles = [
  ...
  { id: 'a11', name: 'Listener Spotlight: Top Fan Stories', body: 'Heartwarming stories from our most dedicated listeners.', tag: 'COMMUNITY', views: 4100, author: 'David Jones', date: '2024-06-10T13:00:00', featured: false, live: true, draft: false },
...
export const seedNotifications = [
  { id: 'n1', title: 'Weekly Chart Reveal', message: 'The Top 40 songs of the week are out! See who made the list.', target: 'Live Stream', date: '2023-10-22T14:30:00', sentBy: 'Marcus J.', reach: 12400 },
  { id: 'n2', title: 'Emergency Traffic Alert', message: 'Major delay on I-95 North. Switch to alternate routes.', target: 'News Article', date: '2023-10-21T08:12:00', sentBy: 'Sarah K.', reach: 45800 },
  { id: 'n3', title: 'Ticket Giveaway: Neon Pulse', message: 'We\'re giving away 5 pairs of VIP passes in 1 hour!', target: 'Contest Page', date: '2023-10-20T19:00:00', sentBy: 'Admin User', reach: 31200 },
  { id: 'n4', title: 'New Morning Show Host', message: 'Welcome DJ Z-Blast to the Morning Mix! Tune in at 6 AM.', target: 'Live Stream', date: '2023-10-18T06:00:00', sentBy: 'Admin User', reach: 28500 },
  { id: 'n5', title: 'Summer Jam Contest Open', message: 'Enter to win VIP passes to Summer Jams 2024!', target: 'Contest Page', date: '2023-10-15T12:00:00', sentBy: 'Marcus J.', reach: 19800 },
]
...
// Ad analytics - per-ad metrics
export const seedAdAnalytics = {
  'ad1': {
    impressions: 12480, clicks: 1842, geofenceEntries: 634, notificationOpens: 287, directionRequests: 156,
    daily: [
      { date: '2024-06-09', impressions: 1120, clicks: 178, geofenceEntries: 52, notificationOpens: 24 },
      { date: '2024-06-10', impressions: 1340, clicks: 215, geofenceEntries: 68, notificationOpens: 31 },
      { date: '2024-06-11', impressions: 1580, clicks: 248, geofenceEntries: 74, notificationOpens: 38 },
      { date: '2024-06-12', impressions: 1890, clicks: 287, geofenceEntries: 92, notificationOpens: 45 },
      { date: '2024-06-13', impressions: 2100, clicks: 312, geofenceEntries: 108, notificationOpens: 52 },
      { date: '2024-06-14', impressions: 2250, clicks: 328, geofenceEntries: 120, notificationOpens: 51 },
      { date: '2024-06-15', impressions: 2200, clicks: 274, geofenceEntries: 120, notificationOpens: 46 },
    ],
  },
  'ad2': {
    impressions: 8920, clicks: 1204, geofenceEntries: 412, notificationOpens: 198, directionRequests: 89,
    daily: [
      { date: '2024-06-09', impressions: 680, clicks: 92, geofenceEntries: 28, notificationOpens: 14 },
      { date: '2024-06-10', impressions: 920, clicks: 134, geofenceEntries: 42, notificationOpens: 22 },
      { date: '2024-06-11', impressions: 1140, clicks: 168, geofenceEntries: 56, notificationOpens: 28 },
      { date: '2024-06-12', impressions: 1380, clicks: 198, geofenceEntries: 72, notificationOpens: 34 },
      { date: '2024-06-13', impressions: 1520, clicks: 212, geofenceEntries: 78, notificationOpens: 38 },
      { date: '2024-06-14', impressions: 1640, clicks: 208, geofenceEntries: 74, notificationOpens: 32 },
      { date: '2024-06-15', impressions: 1640, clicks: 192, geofenceEntries: 62, notificationOpens: 30 },
    ],
  },
  'ad3': {
    impressions: 15200, clicks: 2680, geofenceEntries: 890, notificationOpens: 412, directionRequests: 234,
    daily: [
      { date: '2024-06-09', impressions: 1420, clicks: 268, geofenceEntries: 82, notificationOpens: 38 },
      { date: '2024-06-10', impressions: 1680, clicks: 312, geofenceEntries: 98, notificationOpens: 46 },
      { date: '2024-06-11', impressions: 2040, clicks: 378, geofenceEntries: 118, notificationOpens: 56 },
      { date: '2024-06-12', impressions: 2380, clicks: 428, geofenceEntries: 142, notificationOpens: 68 },
      { date: '2024-06-13', impressions: 2560, clicks: 456, geofenceEntries: 156, notificationOpens: 72 },
      { date: '2024-06-14', impressions: 2720, clicks: 438, geofenceEntries: 152, notificationOpens: 68 },
      { date: '2024-06-15', impressions: 2400, clicks: 400, geofenceEntries: 142, notificationOpens: 64 },
    ],
  },
  'ad4': {
  ...
  'ad5': {
    impressions: 4200, clicks: 520, geofenceEntries: 180, notificationOpens: 78, directionRequests: 42,
    daily: [
      { date: '2024-04-28', impressions: 580, clicks: 72, geofenceEntries: 24, notificationOpens: 10 },
      { date: '2024-04-29', impressions: 640, clicks: 84, geofenceEntries: 28, notificationOpens: 12 },
      { date: '2024-04-30', impressions: 720, clicks: 92, geofenceEntries: 32, notificationOpens: 14 },
      { date: '2024-05-01', impressions: 780, clicks: 98, geofenceEntries: 34, notificationOpens: 15 },
      { date: '2024-05-02', impressions: 760, clicks: 90, geofenceEntries: 32, notificationOpens: 14 },
      { date: '2024-05-03', impressions: 720, clicks: 84, geofenceEntries: 30, notificationOpens: 13 },
    ],
  },
}
